    ...
    <div class="lobby">
        <div>
            ...
            <div v-for="game in lobbyList" class="game" :key="game.id" @click="openGame(game)" v-if="game.author !== 'auto-game' || settings.enabledDisplayAutoGame">
                ...
                <div class="text-center">{{ game.players.max == 11 && !game.isLobby ? (game.playersNotDead-1) : game.playersNotDead }}/{{ game.players.max == 11 && !game.isLobby ? (game.players.max-1) : game.players.max }}</div>
